    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-primary fixed-top py-3" id="mainNav">
        <div class="container">
            ...
            <img src="../assets/img/navimg.png" alt="">
                ...
                <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#about">BEM VINDO <?= $nome?>!</a></li>
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#about">Ver perfil</a></li>
